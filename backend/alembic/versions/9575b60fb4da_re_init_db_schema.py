...
Revision ID: 9575b60fb4da
Revises: 
Create Date: 2025-07-31 23:17:24.016502
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('adjustement_id', sa.Integer(), nullable=False),
    ...
    sa.Column('sale_id', sa.Integer(), nullable=False),
    sa.Column('invoice_id', sa.Integer(), nullable=False),
    sa.Column('cash_transac_id', sa.Integer(), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_by_id', sa.Integer(), nullable=True),
    sa.Column('sale_details_line_id', sa.Integer(), nullable=True),
    sa.Column('purchase_details_line_id', sa.Integer(), nullable=True),
    sa.Column('order_details_line_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['area_id'], ['area.id'], ),
    sa.ForeignKeyConstraint(['created_by_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['initiated_by_id'], ['employee.id'], ),
